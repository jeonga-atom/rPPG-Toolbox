...
_C.TRAIN.DATA.UBFC_ORIG_PATH = os.path.join(os.getcwd(), 'data', 'UBFC-rPPG')
...
_C.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH_SEC = 0.0
...
_C.VALID.DATA.UBFC_ORIG_PATH = _C.TRAIN.DATA.UBFC_ORIG_PATH
...
_C.VALID.DATA.PREPROCESS.CHUNK_LENGTH_SEC = 0.0
...
_C.TEST.DATA.UBFC_ORIG_PATH = _C.TRAIN.DATA.UBFC_ORIG_PATH
...
_C.TEST.DATA.PREPROCESS.CHUNK_LENGTH_SEC = 0.0
...
_C.UNSUPERVISED.DATA.UBFC_ORIG_PATH = _C.TRAIN.DATA.UBFC_ORIG_PATH
...
_C.UNSUPERVISED.DATA.PREPROCESS.CHUNK_LENGTH_SEC = 0.0
